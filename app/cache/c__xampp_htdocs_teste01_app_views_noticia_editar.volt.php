                                    ...
                                    <div class="panel-body">
                                            ...
                                            <div class="form-group col-sm-12">
                                                ...
                                                <select name="categoria_id">
                                                    <?php foreach ($categorias as $categoria) { ?>
                                                        ...
                                                        <option value="<?= $categoria->id ?>" <?php if ($categoria->id == $noticia->categoria_id) { ?> selected <?php } ?>><?= $categoria->titulo ?></option>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                ...
                                                <input type="checkbox" name="publicado" id="publicado" <?php if ($noticia->publicado == 1) { ?> checked <?php } ?>>
                                            </div>
                                        </div>
